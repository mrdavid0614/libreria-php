...
-- Dumping structure for table libreria.autores
...
-- Dumping data for table libreria.autores: 22 rows
DELETE FROM `autores`;
...
-- Dumping structure for table libreria.biografias
...
-- Dumping data for table libreria.biografias: 6 rows
DELETE FROM `biografias`;
...
-- Dumping structure for table libreria.contacto
...
-- Dumping data for table libreria.contacto: 1 rows
DELETE FROM `contacto`;
/*!40000 ALTER TABLE `contacto` DISABLE KEYS */;
INSERT INTO `contacto` (`id`, `fecha`, `correo`, `nombre`, `asunto`, `comentario`) VALUES
	(1, '2023-08-02 00:26:43', 'example@prueba.com', 'Prueba1', 'Probando contacto', 'Hola Mundo');
/*!40000 ALTER TABLE `contacto` ENABLE KEYS */;

-- Dumping structure for table libreria.derechos
...
-- Dumping data for table libreria.derechos: 86 rows
DELETE FROM `derechos`;
...
-- Dumping structure for table libreria.descuento
...
-- Dumping data for table libreria.descuento: 4 rows
...
-- Dumping structure for table libreria.detalle_venta
...
-- Dumping data for table libreria.detalle_venta: 112 rows
...
-- Dumping structure for table libreria.fotografias
...
-- Dumping data for table libreria.publicadores: 3 rows
DELETE FROM `publicadores`;
...
-- Dumping structure for table libreria.tiendas
...
-- Dumping data for table libreria.tiendas: 7 rows
DELETE FROM `tiendas`;
...
-- Dumping structure for table libreria.titulos
...
-- Dumping data for table libreria.titulos: 18 rows
DELETE FROM `titulos`;
...
-- Dumping structure for table libreria.titulo_autor
...
-- Dumping data for table libreria.titulo_autor: 25 rows
...
-- Dumping structure for table libreria.ventas
...
-- Dumping data for table libreria.ventas: 30 rows
DELETE FROM `ventas`;
